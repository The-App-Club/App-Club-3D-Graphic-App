...
class WebGL {
  constructor() {
    ...
    this.elms = {
      ...
      mvQiitaLink: document.querySelector('[data-mv="officialLink"]'),
      mvGitLink: document.querySelector('[data-mv="noteLink"]'),
    ...
    // this.srcObj = './assets/model/house.glb';
    this.srcObj = './assets/model/santa.glb';
    this.flg = {
      loaded: false,
    };
    this.init();
  ...
  initCamera() {
    ...
    this.three.camera = new THREE.PerspectiveCamera(
      this.three.cameraFov,
      this.winSize.wd / this.winSize.wh,
      this.three.cameraAspect,
      1000
    );
  ...
  setLoading() {
    ...
    loader.load(this.srcObj, (model) => {
      const data = model.scene;
